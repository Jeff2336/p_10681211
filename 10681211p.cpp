          ...
          { system("cls");
           ...
           { system("cls");
             ...
             {  while (eSLoop<=100)
                   ...
                   { system("cls");
                    cout<<"You are to enter all the lecturer's courses again\n";
                    cout<<"(Correcting any mistakes you had made prior\n)";
    ...
    for(r=0;r<t.CNum[i-1];r++)
      ...
      break;
          ...
          x++;
            ...
            { while(e<=10)
          { system("cls");
           cout<<"Enter the number of the lecturer whose records you want to delete( e.g.enter 1 for student 1 and so on....)\n";
           cin>>del;
           t.FName[del-1]=" ";
           t.LName[del-1]=" ";
           t.ID[del-1]=" ";
